...
export default function IpMonitorPanel({ ipStats, isLoading }: Props) {
  if (isLoading) {
    return (
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              {stat.isSuspicious && (
                <span className="text-[10px] px-2 py-0.5 rounded-full font-bold border bg-rose-500/10 text-rose-400 border-rose-500/20 uppercase tracking-wide">
                  Suspicious
                </span>
              )}
            ...
            <div className="flex items-center gap-4 text-right">
              <div className="flex flex-col">
                ...
                <span className={`text-lg font-black font-mono ${stat.isSuspicious ? "text-rose-400" : "text-white"}`}>
                  {stat.requestCount}
                </span>
              </div>
              <div className="flex flex-col">
